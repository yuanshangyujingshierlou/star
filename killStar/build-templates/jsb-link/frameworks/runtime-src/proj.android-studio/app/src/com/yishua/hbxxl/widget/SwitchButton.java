package com.yishua.hbxxl.widget;
...
/**
 * Created by Junguo.L on 2020/4/27.
 */
public class SwitchButton extends AppCompatCheckBox {
     ...
     * 开关未选中状态,即关闭状态时的背景颜色
     */
    private int mBackgroundColorUnchecked = 0x330976A8;
    /**
     * 开关选中状态,即打开状态时的背景颜色
     */
    private int mBackgroundColorChecked = 0xFF48DC31;
    /**
     * 开关指示器按钮的颜色
     */
