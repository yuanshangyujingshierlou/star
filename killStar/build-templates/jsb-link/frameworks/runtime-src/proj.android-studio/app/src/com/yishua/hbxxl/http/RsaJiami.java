...
//		RsaJiami.jiami(timestamp, "0");
//	}

	private static String saltkey = "zQvkNizkjzcA";
	 ...
	 *            13位时间戳
	 * @param userid
	 *            用户的userid，未登录或其他异常传0,不要空着
	 * @return
	 * @throws Exception
	 */
	public static String jiami(String timestamp, String userid) throws Exception {

		String src = timestamp + "," + userid + "," + saltkey;
